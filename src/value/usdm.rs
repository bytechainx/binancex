...
crate::value::typed_kline!(UsdmContinuousKline, "USDM 连续合约 K 线响应。");

crate::value::typed_kline!(UsdmKline, "USDM 原生 K 线响应。");

crate::value::typed_kline!(UsdmIndexPriceKline, "USDM 指数价格 K 线响应。");

crate::value::typed_kline!(UsdmMarkPriceKline, "USDM 标记价格 K 线响应。");
...
crate::value::typed_kline!(UsdmPremiumIndexKline, "USDM 溢价指数 K 线响应。");
...
pub use market_data::{
    ...
    UsdmConstituents, UsdmConstituentsConstituentsItem, UsdmConvertExchangeInfo,
    UsdmConvertExchangeInfoItem, UsdmDeliveryPrice, UsdmDeliveryPriceItem, UsdmInsuranceBalance,
    UsdmInsuranceBalanceItem, UsdmInsuranceBalanceItemAssetsItem, UsdmTradingSchedule,
    UsdmTradingScheduleMarketSchedulesValue, UsdmTradingScheduleMarketSchedulesValueSessionsItem,
};
